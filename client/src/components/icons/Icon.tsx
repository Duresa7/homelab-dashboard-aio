...
const PATHS: Record<IconName, ReactElement> = {
  ...
  network: (
    <>
      ...
      <path d="M12 8v4M8 14l3-2M16 14l-3-2" />
    </>
  ),
  box: (
    <>
  ...
  settings: (
    <>
      ...
      <path d="M19.4 15a7.97 7.97 0 0 0 0-6l1.6-1.3-2-3.4-2 .8a8 8 0 0 0-5.2-3L11.5 0h-4l-.3 2a8 8 0 0 0-5.2 3l-2-.8-2 3.4L0 9a7.97 7.97 0 0 0 0 6l-1.6 1.3" />
    </>
  ),
  moon: (
    <>
  ...
  drag: (
    <>
      <circle cx="9" cy="6" r=".7" fill="currentColor" />
      <circle cx="15" cy="6" r=".7" fill="currentColor" />
      <circle cx="9" cy="12" r=".7" fill="currentColor" />
      <circle cx="15" cy="12" r=".7" fill="currentColor" />
      <circle cx="9" cy="18" r=".7" fill="currentColor" />
      <circle cx="15" cy="18" r=".7" fill="currentColor" />
    </>
  ),
  fan: (
    <>
      <circle cx="12" cy="12" r="2" />
      <path d="M12 10c0-4 1-8-2-8s-2 4-2 6c0 1 1 2 4 2zM12 14c0 4-1 8 2 8s2-4 2-6c0-1-1-2-4-2zM10 12c-4 0-8-1-8 2s4 2 6 2c1 0 2-1 2-4zM14 12c4 0 8 1 8-2s-4-2-6-2c-1 0-2 1-2 4z" />
    </>
  ),
  bolt: (
    <>
  ...
  cloud: (
    <>
      <path d="M7 18a4 4 0 0 1 0-8 6 6 0 0 1 12 1 4 4 0 0 1-1 8z" />
    </>
  ),
  layers: (
    <>
