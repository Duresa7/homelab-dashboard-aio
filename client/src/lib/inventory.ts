...
function makeSeed(): Inventory {
  ...
  const nas: Machine = {
    ...
    meta: [
      ...
      m('IP', '198.51.100.10'),
      m('NIC', '2.5 GbE RJ45 (PoE+++ powered)'),
      m('USB', 'USB-C 5 Gbps'),
      m('Wireless', 'Bluetooth 4.1'),
      m('Display', '1.47" color LCM'),
      m('Power', '90 W PoE+++'),
    ],
  };
  ...
  const comps: Array<{ machine: string } & SeedComp> = [
    // Example PC
    {
      ...
      type: 'cpu',
      label: 'CPU',
      fields: { Brand: 'AMD', Model: 'Ryzen 9 9950X3D', Cores: '16', Threads: '32', Socket: 'AM5' },
    },
    {
      machine: example.id,
      type: 'cooler',
    ...
    },
    {
      ...
      type: 'gpu',
      label: 'GPU',
      fields: { Brand: 'MSI', Model: 'Inspire 3X OC GeForce RTX 5070 Ti', VRAM: '16 GB' },
    },
    {
      machine: example.id,
      type: 'motherboard',
    ...
    },
    {
      ...
      type: 'psu',
      label: 'PSU',
      fields: { Brand: 'CORSAIR', Model: 'RM850e (2025)', Wattage: '850 W' },
    },
    {
      machine: example.id,
      type: 'case',
      ...
      fields: {
        Brand: 'Antec',
        Model: 'FLUX Wood',
        'Form Factor': 'Mid-Tower E-ATX',
        Notes: 'walnut wood front, 5× PWM fans, Type-C',
      },
    },
    {
      machine: example.id,
      type: 'cooler',
      label: 'Thermal Paste',
      fields: { Brand: 'Thermal Grizzly', Model: 'Kryonaut' },
    },
    {
      machine: example.id,
      type: 'nic',
      label: 'NIC',
      fields: { Brand: 'Realtek', Speed: '2.5 GbE', Notes: 'onboard' },
    },
    // OBI PC
    {
      machine: obi.id,
      type: 'cpu',
      label: 'CPU',
      fields: { Brand: 'AMD', Model: 'Ryzen 7 7700X', Cores: '8', Threads: '16', Socket: 'AM5' },
    },
    {
      machine: obi.id,
      type: 'cooler',
      label: 'CPU Cooler',
      fields: { Brand: 'Cooler Master', Model: '240 mm AIO', Type: 'AIO', Size: '240 mm' },
    },
    {
      machine: obi.id,
      type: 'gpu',
      label: 'GPU',
      fields: { Brand: 'MSI', Model: 'NVIDIA GeForce RTX 3070', VRAM: '8 GB' },
    },
    {
      machine: obi.id,
      type: 'motherboard',
      label: 'Motherboard',
      fields: { Brand: 'ASUS', Model: 'TUF Gaming B650-PLUS WiFi', Socket: 'AM5', Chipset: 'B650' },
    },
    {
      machine: obi.id,
      type: 'ram',
    ...
    },
    {
      ...
      type: 'storage',
      label: 'Storage 1',
      fields: { Brand: 'Crucial', Model: 'CT500P310SSD8', Capacity: '500 GB', Interface: 'NVMe' },
    },
    {
      machine: obi.id,
      type: 'psu',
      label: 'PSU',
      fields: { Brand: 'CORSAIR', Model: '750 W', Wattage: '750 W' },
    },
    {
      machine: obi.id,
      type: 'case',
      label: 'Case',
      fields: { Brand: 'NZXT', Model: 'H5 Flow (2023)' },
    },
    {
      machine: obi.id,
      type: 'cooler',
    ...
    // example-server
    {
      ...
      type: 'cpu',
      label: 'CPU',
      fields: { Brand: 'AMD', Model: 'Ryzen 7 3700X', Cores: '8', Threads: '16', Socket: 'AM4' },
    },
    {
      machine: grey.id,
      type: 'cooler',
      ...
      fields: {
        Brand: 'Thermalright',
        Model: 'Phantom Spirit 120 SE Black',
        Type: 'dual-tower air',
        Notes: '7 heat pipes, 2× TL-C12B V2',
      },
    },
    {
      machine: grey.id,
      type: 'gpu',
      label: 'GPU',
      fields: { Brand: 'NVIDIA', Model: 'GeForce GTX 1080 Ti', VRAM: '11 GB' },
    },
    {
      machine: grey.id,
      type: 'motherboard',
      label: 'Motherboard',
      fields: { Brand: 'MSI', Model: 'MAG B550 Tomahawk', Socket: 'AM4', Chipset: 'B550' },
    },
    {
      machine: grey.id,
      type: 'ram',
    ...
    },
    {
      ...
      type: 'storage',
      label: 'Storage 1',
      fields: { Brand: 'Crucial', Model: 'CT1000P310SSD8', Capacity: '1 TB', Interface: 'NVMe' },
    },
    {
      machine: grey.id,
      type: 'storage',
    ...
    },
    {
      ...
      type: 'psu',
      label: 'PSU',
      fields: { Brand: 'Powerspec', Model: '750 W ATX', Wattage: '750 W', Modular: 'Non-Modular' },
    },
    ...
    },
    {
      ...
      type: 'nic',
      label: 'NIC 1',
      fields: { Brand: 'Realtek', Model: 'RTL8125', Speed: '2.5 GbE', Notes: 'onboard' },
    },
    {
      machine: grey.id,
      type: 'nic',
      label: 'NIC 2',
      fields: { Brand: 'Realtek', Model: 'RTL8111/8168', Speed: '1 GbE', Notes: 'onboard' },
    },
    // NAS NAS
    {
      machine: nas.id,
      type: 'cpu',
      label: 'CPU',
      fields: { Model: 'Quad-core ARM Cortex-A55', Notes: '@ 1.7 GHz' },
    },
    {
      machine: nas.id,
      type: 'ram',
      label: 'RAM',
      fields: { Capacity: '4 GB', Notes: 'soldered' },
    },
    {
      machine: nas.id,
      type: 'storage',
    ...
    // node-b
    {
      ...
      type: 'cpu',
      label: 'CPU',
      fields: { Brand: 'Intel', Model: '8th-gen Core (T-series)', Socket: 'LGA1151' },
    },
    {
      machine: purple.id,
      type: 'ram',
      ...
      fields: {
        Brand: 'Micron',
        Model: 'MTA8ATF1G64HZ-2G6E1',
        Type: 'DDR4',
        Speed: '2666 MT/s',
        Capacity: '8 GB',
        'Form Factor': 'SO-DIMM',
        Notes: 'Lenovo FRU 01AG841',
      },
    },
    {
      machine: purple.id,
      ...
      fields: {
        Brand: 'SK hynix',
        Model: 'HMA81GS6AFR8N-UH',
        Type: 'DDR4',
        Speed: '2400 MT/s',
        Capacity: '8 GB',
        'Form Factor': 'SO-DIMM',
        Notes: 'runs at 2400 MT/s — slower module sets the bus',
      },
    },
    {
      machine: purple.id,
    ...
    },
    {
      ...
      fields: {
        ...
        Notes: 'MTM ASSET-EXAMPLE-001, 20 V / 3.25 A',
      },
    },
    ...
    // node-c
    {
      ...
      type: 'cpu',
      label: 'CPU',
      fields: { Brand: 'Intel', Model: '6th/7th-gen Core (T-series)', Socket: 'LGA1151' },
    },
    {
      machine: blue.id,
      type: 'ram',
      ...
      fields: {
        Brand: 'SK hynix',
        Model: 'HMA81GS6CJR8N-VK',
        Type: 'DDR4',
        Speed: '2666 MT/s',
        Capacity: '8 GB',
        'Form Factor': 'SO-DIMM',
        Notes: 'Lenovo FRU 01AG824, factory',
      },
    },
    {
      machine: blue.id,
    ...
    },
    {
      ...
      fields: {
        Brand: 'Samsung',
        Model: 'PM961 (MZ-VLW2560)',
        Capacity: '256 GB',
        'Form Factor': 'M.2',
        Interface: 'NVMe',
        Notes: 'Lenovo FRU 00UP436',
      },
    },
    {
      machine: blue.id,
      ...
      fields: {
        ...
        Notes: 'MTM 10MU / S08B00, MFG 04/2018, 20 V / 3.25 A',
      },
    },
    ...
    // Spare components (dissolved from the old component categories)
    {
      ...
      type: 'cpu',
      label: 'CPU',
      fields: { Brand: 'Intel', Model: 'Core i7-5820K', Cores: '6', Socket: 'LGA 2011-v3' },
    },
    {
      machine: SPARE,
      type: 'cooler',
      label: 'CPU Cooler',
      fields: { Brand: 'AMD', Model: 'Wraith Prism', Type: 'air', Notes: 'Stock cooler, RGB' },
    },
    {
      machine: SPARE,
      type: 'cooler',
      label: 'CPU Cooler',
      fields: { Brand: 'AMD', Model: 'Wraith Stealth', Type: 'air', Notes: 'Stock cooler' },
    },
    {
      machine: SPARE,
      type: 'storage',
    ...
    },
    {
      ...
      fields: {
        Brand: 'Seagate',
        Model: 'ST1000LM035 (Mobile HDD)',
        Capacity: '1 TB',
        'Form Factor': '2.5"',
      },
      rawSpec: 'serial SERIAL-EXAMPLE-003 · part PART-EXAMPLE-001',
    },
    {
      machine: SPARE,
      type: 'storage',
    ...
    },
    {
      ...
      fields: {
        Brand: 'Samsung',
        Model: 'M471A5644EB0-CPB',
        Capacity: '2 GB',
        Type: 'DDR4',
        Speed: '2133 MT/s',
        'Form Factor': 'SO-DIMM',
        Notes: 'PC4-2133P, 1Rx16',
      },
    },
  ];
      ...
      comp.problemLog = [
        {
          id: genId('p'),
          date: '2026-05-30',
          note: 'Bad sectors detected, end of life — failed its SMART test.',
        },
      ];
    }
  ...
  const dev = (values: Record<string, string>, extra: Partial<SpareItem> = {}): SpareItem => ({
    id: genId('s'),
    deployment: 'spare',
    values,
    ...extra,
  ...
  const spares: SpareCategory[] = [
        ...
        dev(
          {
            ...
            notes: 'Multi-gig fiber gateway',
            qty: '1',
          },
          { name: 'Gateway Gateway', deployment: 'in-service' },
        ),
        dev(
          {
            role: 'Switch',
            ...
            notes: '2.5 GbE, 5 ports',
            qty: '1',
          },
          { name: 'SwitchA-Switch', deployment: 'in-service' },
        ),
        dev(
          {
            role: 'Switch',
          ...
          { name: 'SwitchB-Switch', deployment: 'in-service' },
        ),
        dev(
          {
            role: 'Switch',
            brand: 'Ubiquiti',
            model: 'USW-Pro-Max-16-PoE (Pro Max 16 PoE)',
            notes: '16-port multi-gig PoE',
            qty: '1',
          },
          { name: 'Switch Switch PoE', deployment: 'in-service' },
        ),
        dev(
          {
            role: 'Wi-Fi AP',
            brand: 'Ubiquiti',
            model: 'U7-Pro-XG',
            notes: 'Wi-Fi 7, 10 GbE uplink',
            qty: '1',
          },
          { name: 'AccessPoint AP', deployment: 'in-service' },
        ),
      ],
    },
    {
        ...
        dev(
          {
            ...
            notes: 'PoE bullet security cam',
          },
          { name: 'Outside-Left', deployment: 'in-service' },
        ),
      ],
    },
    {
      ...
      items: [
        ...
        dev({
          brand: 'Apple',
          model: 'MacBook Pro 15" 2017 (Touch Bar)',
          cpu: 'Intel Core i7',
          ram: '16 GB',
          storage: '1 TB',
        }),
        dev({
          brand: 'Lenovo',
          model: 'ThinkPad T440',
          cpu: 'Verify on boot (Intel 4th-gen Core)',
          ram: 'Verify on boot',
          storage: 'Verify on boot',
        }),
        dev({
          brand: 'Lenovo',
          model: 'ThinkPad T470s',
          cpu: 'Verify on boot (Intel 7th-gen Core)',
          ram: 'Verify on boot',
          storage: 'Verify on boot',
        }),
        dev({
          brand: 'Lenovo',
          model: 'ThinkPad T480',
          cpu: 'Verify on boot (Intel 8th-gen Core)',
          ram: 'Verify on boot',
          storage: 'Verify on boot',
        }),
      ],
    ...
    },
    {
      ...
      items: [
        dev({
          brand: 'Cisco',
          model: 'FPR-1010 (Firepower 1010)',
          type: 'Next-gen firewall / security appliance',
          notes:
            'PID: FPR-1010 V01, 8× 1 GbE + mgmt, SN JMX2726X1SC, mfg 06/29/2023, Made in Mexico',
        }),
        dev({ brand: 'ASUS', model: 'RT-AX3000', type: 'Wi-Fi 6 router', notes: '' }),
        dev({
          brand: 'TP-Link',
          model: 'TL-SG108E',
          type: '8-port managed switch (1 GbE)',
          notes: 'Easy Smart, QoS / VLAN / IGMP / LAG',
        }),
        dev({
          brand: 'Netgear',
          model: 'GS308',
          type: '8-port unmanaged switch (1 GbE)',
          notes: '',
        }),
        dev({
          brand: 'Netgear',
        ...
        dev({
          brand: 'Netgear',
          model: 'FS726TP ProSafe',
          type: '24-port smart switch (10/100) + 2× 1 GbE',
          notes: 'PoE',
        }),
        dev({
          brand: '(Generic)',
          model: 'PS1080',
          type: '8-port PoE unmanaged switch (1 GbE)',
          notes: 'IEEE 802.3af, 100–240 VAC input, 48 VDC output',
        }),
      ],
    },
    {
      ...
      items: [
        dev({
          brand: 'HP',
          model: 'DeskJet 4255e',
          type: 'All-in-one inkjet (print/scan/copy)',
          notes: 'Wi-Fi',
        }),
      ],
    },
